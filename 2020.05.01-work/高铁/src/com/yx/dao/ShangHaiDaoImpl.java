...
public class ShangHaiDaoImpl implements HSRTicket {
	
	String trainInfo = "你乘坐的车次："+TRAIN_NUMBER+","+"始发站--目的站："+START_TATION+"--上海,"+"座位等级：";
	String seat1="一等座";
	String seat2="二等座";
	...
	public void run(String seatlevel) {
		if (seatlevel.equals(seat1)) {
			...
			System.out.println(trainInfo+seat2+",车票价格为"+139.5+"元");
			}
		else{
